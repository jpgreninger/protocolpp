...
the  Galois/Counter  Mode  (GCM),  an  algorithm  for
...
AUTHORITY .....................................................................................................................................................1
INTRODUCTION..............................................................................................................................................1
DEFINITIONS, ABBREVIATIONS, AND SYMBOLS .................................................................................2
...
BLOCK CIPHER ............................................................................................................................................7
TWO GCM FUNCTIONS ...............................................................................................................................7
Authenticated Encryption Function .......................................................................................................8
Authenticated Decryption Function .......................................................................................................9
PRIMITIVES FOR CONFIDENTIALITY AND AUTHENTICATION........................................................................9
6  MATHEMATICAL COMPONENTS OF GCM...........................................................................................10
EXAMPLES OF BASIC OPERATIONS AND FUNCTIONS ON STRINGS .............................................................10
INCREMENTING FUNCTION ........................................................................................................................11
MULTIPLICATION OPERATION ON BLOCKS................................................................................................11
GHASH FUNCTION ...................................................................................................................................12
GCTR FUNCTION ......................................................................................................................................13
GCM SPECIFICATION .................................................................................................................................14
ALGORITHM FOR THE AUTHENTICATED ENCRYPTION FUNCTION..............................................................14
ALGORITHM FOR THE AUTHENTICATED DECRYPTION FUNCTION..............................................................16
UNIQUENESS REQUIREMENT ON IVS AND KEYS ..............................................................................18
KEY ESTABLISHMENT ...............................................................................................................................19
IV CONSTRUCTIONS ..................................................................................................................................19
8.2.1  Deterministic Construction..................................................................................................................20
RBG-based Construction .....................................................................................................................20
8.2.2
CONSTRAINTS ON THE NUMBER OF INVOCATIONS.....................................................................................21
PRACTICAL CONSIDERATIONS FOR VALIDATING IMPLEMENTATIONS .................................22
...
The  input  data  to  the  authenticated  encryption  function  that  is
...
The  function  of  GCM  in  which  the  ciphertext  is  decrypted  into  the
plaintext,  and  the  authenticity  of  the  ciphertext  and  the  AAD  is
verified.

The  function  of  GCM  in  which  the  plaintext  is  encrypted  into  the
ciphertext, and an authentication tag is generated on the AAD and the
ciphertext.
...
For a given block cipher, a bit string whose length is the block size of
the block cipher.
...
For  a  given  block  cipher  and  key,  the  fixed  length  of  the  input  (or
output) bit strings.
...
In  the  RBG-based  construction  of  IVs,  an  output  string  of  an  RBG
...
In  the  deterministic  construction  of  IVs,  the  field  that  identifies  the
...
A permutation on blocks that is determined by the choice of a key for
a given block cipher.

Free Field

In  the  RBG-based  construction  of  IVs,  the  field  whose  contents  are
not restricted.
...
For  a  newly  generated  key,  the  property  of  being  unequal  to  any
previously used key.
...
A  nonce  that  is  associated  with  an  invocation  of  authenticated
encryption on a particular plaintext and AAD.

Inverse Cipher Function

The  function  that  is  the  inverse  of  the  forward  cipher  function  for  a
given key.
...
The parameter of the block cipher that determines the selection of the
...
An  algorithm  for  the  cryptographic  transformation  of  data  that  is
...
The  input  data  to  the  authenticated  encryption  function  that  is  both
authenticated and encrypted.

In  the  RBG-based  construction  of  IVs,  either  a  direct  random  string
or one of its successors.

Random Bit Generator

In  the  RBG-based  construction  of  IVs,  the  result  of  one  or  more
...
The  output  of  the  forward  cipher  function  of  the  block  cipher  under  the
key K applied to the block X.

GCTRK (ICB, X)

The  output  of  the  GCTR  function  for  a  given  block  cipher  with  key  K
applied to the bit string X with an initial counter block ICB.

GHASHH (X)

The  output  of  the  GHASH  function  under  the  hash  subkey  H  applied  to
the bit string X.
...
The  output  of  incrementing  the  right-most  s  bits  of  the  bit  string  X,
...
The binary representation of the non-negative integer x as a string of s bits,
where x<2s.

The bit string that results from discarding the rightmost bit of the bit string
...
The  product  of  two  blocks,  X  and  Y,  regarded  as  elements  of  a  certain
binary Galois field.
...
MSBs(X) return the s least significant (i.e., right-most) bits and the s most significant (i.e., left-
  For  example,  LSB3(111011010)  =  010,  and
most)  bits,
MSB4(111011010) = 1110.
...
Let x0x1...x127 denote the sequence of bits in X.
Let Z0 = 0128 and V0 = Y.
For i = 0 to 127, calculate blocks Zi+1 and Vi+1 as follows:
...
* is either a complete block or a nonempty partial block, and if 1 ≤ len(X) ≤128, then X = X1
...
MSB
0
, then return P; else return FAIL.
...
Ferguson,  N.,  Authentication  Weaknesses  in  GCM,  Natl.  Inst.  Stand.  Technol.
[Web  page],  http://www.csrc.nist.gov/groups/ST/toolkit/BCM/documents/comments/
CWC-GCM/Ferguson2.pdf, May 20, 2005.

FIPS  Publication  197,  The  Advanced  Encryption  Standard  (AES),  U.S.  DoC/NIST,
November 26, 2001.

FIPS  Publication  140-2,  Security  Requirements  for  Cryptographic  Modules,  U.S.
...
A.  Joux,  Authentication  Failures  in  NIST  version  of  GCM,  Natl.  Inst.  Stand.  Technol.
...
[Web  page],  http://www.csrc.nist.gov/groups/ST/toolkit/BCM/documents/
