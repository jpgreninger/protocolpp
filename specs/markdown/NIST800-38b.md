...
Date updated: (cid:75)(cid:272)(cid:410)(cid:381)(cid:271)(cid:286)(cid:396)(cid:3)(cid:1010), 201(cid:1010)
...
EXAMPLES OF OPERATIONS AND FUNCTIONS ..............................................................................................5
BLOCK CIPHER ............................................................................................................................................5
SUBKEYS .....................................................................................................................................................6
MAC GENERATION AND VERIFICATION......................................................................................................6
INPUT AND OUTPUT DATA...........................................................................................................................7

6

CMAC SPECIFICATION.................................................................................................................................7
...
ASSURANCE AGAINST GUESSING ATTACKS ..............................................................................................11
SELECTION OF THE MAC LENGTH.............................................................................................................11
...
An  algorithm  for  a  parameterized  family  of  permutations  on  bit
strings of a fixed length.

For a given block cipher, the fixed length of the input (or output) bit
strings.
...
For a given function, a pair of distinct input values that yield the same
output value.
...
A  bit  string  of  fixed  length,  computed  by  a  MAC  generation
algorithm,  that  is  used  to  establish  the  authenticity  and,  hence,  the
...
An  algorithm  that  verifies  if  a  purported  MAC  is  valid  for  a  given
message and key.
...
The  output  of  the  forward  cipher  function  of  the  block  cipher  under  the  key  K
...
The bit string that results from discarding the leftmost bit of the bit string X and
...
Given a real number x, the ceiling function, denoted (cid:170)x(cid:186), is the least integer that is not less than x.
For example, (cid:170)2.1(cid:186) = 3, and  (cid:170)4(cid:186) = 4.

The concatenation operation on bit strings is denoted ||; for example, 001 || 10111 = 00110111.

Given bit strings of equal length, the exclusive-OR operation, denoted (cid:134), specifies the addition,
modulo 2, of the bits in each bit position, i.e., without carries.  For example, 10011 (cid:134) 10101 =
00110.
...
Else K1 = (L << 1) (cid:134) Rb;  see Sec. 5.3 for the definition of Rb.
If MSB1(K1) = 0, then K2 = K1 << 1;
Else K2 = (K1 << 1) (cid:134) Rb.
...
* denote the unique sequence of bit strings such that M =

*  is  a  complete  block,  let  Mn =  K1 (cid:134) Mn

*, where M1, M2,..., Mn-1 are complete blocks.2

Apply the subkey generation process in Sec. 6.1 to K to produce K1 and K2.
 If Mlen = 0, let n = 1; else, let n = (cid:170)Mlen/b(cid:186).
 Let M1, M2, ... , Mn-1, Mn
M1 || M2 || ... || Mn-1 || Mn
 If  Mn
where j = nb-Mlen-1.
 Let C0 = 0b.
 For i = 1 to n, let Ci = CIPHK(Ci-1 (cid:134) Mi).
 Let T = MSBTlen(Cn).
 Return T.

*;  else,  let  Mn =  K2 (cid:134)  (Mn
...
1  As  detailed  in  Ref.  [5],  the  generation  of  K1  and  K2 is  essentially  equivalent  to  multiplication  by  u  and  u2,
...
2 Consequently, if Mlen (cid:148) b, then M = M1
...
If  the  message  length  is  a  positive  multiple  of  the  block  size,  then  the  message  is
...
Assurance Against Guessing Attacks
...
Tlen (cid:116) lg(MaxInvalids / Risk) .
...
3 The MAC before truncation is denoted Cm in Sec. 6.2.
4 The standard definition of a collision, in Ref. [9], for example, is more general: for a given function, a collision is a
...
FIPS Publication 198, The Keyed-Hash Message Authentication Code, U.S. DoC/NIST,
March 6, 2002.

T. Iwata, K. Kurosawa, OMAC: One-Key CBC MAC, Natl. Inst. Stand. Technol. [Web
page], http://csrc.nist.gov/CryptoToolkit/modes/proposedmodes/.

T. Iwata, K. Kurosawa, OMAC: One-Key CBC MAC, in Fast Software  Encryption, 10th
