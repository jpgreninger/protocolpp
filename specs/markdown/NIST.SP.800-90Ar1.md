...
The Internal State ........................................................................................................... 12

7.4

The DRBG Mechanism Functions................................................................................. 12
...
Security Strengths Supported by an Instantiation...................................................... 14
...
Seed Construction for Instantiation ................................................................ 18

8.6.2

Seed Construction for Reseeding ................................................................... 18

8.6.3

Entropy Requirements for the Entropy Input ................................................. 18
...
Entropy Input and Seed Privacy ...................................................................... 19
...
Other Input to the DRBG Mechanism .......................................................................... 21

8.7.1

Personalization String....................................................................................... 21
...
Prediction Resistance and Backtracking Resistance................................................. 23

9

DRBG Mechanism Functions ...................................................................... 25

9.1

Instantiating a DRBG...................................................................................................... 26
...
Integer to a Bitstring ...................................................................................................... 67

A.3

Integer to a Byte String .................................................................................................. 68
...
The Simple Discard Method ............................................................................. 69

A.5.2

The Complex Discard Method .......................................................................... 69

A.5.3

The Simple Modular Method ............................................................................ 70
...
The CTR_DRBG_Update Function ................................................................... 80
...
Instantiation of CTR_DRBG Using a Derivation Function ............................. 81
...
The CTR_DRBG_Update Function ................................................................... 86

B.4.2

Instantiation of CTR_DRBG Without a Derivation Function.......................... 86
...
A symmetric-key cryptographic algorithm that transforms one
...
The application (including middleware) that uses random
...
An RBG that includes a DRBG mechanism and (at least
initially) has access to a randomness source. The DRBG
...
An input bitstring that provides an assessed minimum amount
of unpredictability for a DRBG mechanism. (See min-
entropy.)

A combination of a noise source (e.g., thermal noise or hard
...
A  bitstring  output  from  an  entropy  source,  an  NRBG  or  a
DRBG that has access to a Live Entropy Source that is being
used to provide prediction resistance.

Full Entropy

For the purposes of this Recommendation, a source of full-
...
Each  bit  of  an  ideal  random  sequence  is  unpredictable  and
...
an implementation of this Recommendation conforms to the
...
An approved entropy source (see [SP 800-90B]) that can
...
An RBG that always has access to an entropy source and
(when working properly) produces output bitstrings that have
full entropy.  Often called a True Random Number (or Bit)
Generator.  (Contrast with a deterministic random bit
generator).
...
An optional string of bits that is combined with a secret
...
An RBG provides prediction resistance relative to time T if it
...
A component of a DRBG (which consists of a DRBG
...
To acquire additional bits that will affect the internal state of
the DRBG mechanism.
...
The period of time between instantiating or reseeding a DRBG
...
Keyed-Hash Message Authentication Code, as specified in [FIPS 198].
...
Triple Data Encryption Algorithm, as specified in [SP 800-67].
...
Concatenation of two strings X and Y. X and Y are either both bitstrings
or both byte strings.

The ceiling of x; the smallest integer ≥ x. For example, ⎡5⎤ = 5, and
⎡5.3⎤ = 6.
...
The unique remainder r (where 0 ≤ r ≤ n-1) when integer x is divided
...
The internal state of the DRBG at a point in time. The types and
...
Hexadecimal notation that is used to define a byte (i.e., eight bits) of
...
periods that begin when a new seed is
...
Entropy Requirements for the Entropy Input
...
Entropy Input and Seed Separation
...
•	  Random numbers,
•	  Nonces, and
•  Outputs from other approved or non-
...
Comment: This null step replaces a step from the
...
Comment: This step shall include any appropriate
...
pseudorandom_bits: The pseudorandom bits that were requested or a Null string.
...
Reseeding at the End of the Seedlife
...
Handling Prediction Resistance Requests
...
shall be used for all block cipher operations of this
...
Maximum number of requests between
...
Instantiation When a Derivation Function is Not Used
...
Comment: blocklen bits of zeros.
...
Reseeding When a Derivation Function is Not Used
...
Generating Pseudorandom Bits When a Derivation Function is Not Used
...
Generating Pseudorandom Bits When a Derivation Function is Used
...
Comment: An 8-bit binary value representing the
integer "1".
...
Comment: L is the bitstring representation of the
integer resulting from len (input_string)/8. L shall
be represented as a 32-bit integer.

Comment: N is the bitstring representation of the
...
Comment: The 32-bit integer representation of i is
...
Testing the Uninstantiate Function
...
Errors Encountered During Normal Operation
...
Errors Encountered During Health Testing
...
The requested integer representation of the bitstring.
...
The bitstring representation of the integer x.
...
this method, in general, is that the time needed to generate such a random a is not a fixed length
...
Reseeding a Hash_DRBG Instantiation
...
Generating Pseudorandom Bits Using Hash_DRBG
...
status = Hash_DRBG_Reseed_ function (state_handle,
...
Generating Pseudorandom Bits Using HMAC_DRBG
...
internal_state (state_handle).V = V.

7.2

internal_state (state_handle).Key = Key.
...
If (reseed_counter ≥ 10 000), then Return (“Reseed required”, Null, V, Key,
reseed_counter).
...
Instantiation of CTR_DRBG Using a Derivation Function
...
Reseeding a CTR_DRBG Instantiation Using a Derivation Function
...
internal_state (state_handle). security_strength = security_strength.
...
Generating Pseudorandom Bits Using CTR_DRBG
...
status = CTR_DRBG_Reseed_function (state_handle,
...
Instantiation of CTR_DRBG Without a Derivation Function
...
Reseeding a CTR_DRBG Instantiation Without a Derivation Function
...
Federal Information Processing Standard (FIPS) 198-1, The Keyed-Hash Message
...
In Section 6, a link was provided to examples for the DRBGs specified in this
...
In Section 7.2, paragraph 3. 2nd sentence: The “should” has been changed to “shall”, so
...
In Section 8.2, paragraph 2, additional text was added to the first sentence, which now
reads:
...
In Section 8.5, Figure 4 has been updated, and the last paragraph has been revised to
discuss the use of a secure channel.

In Sections 8.6.5 and 8.6.9, statements were inserted that prohibit a DRBG instantiation
...
Section 8.8: An example was added to further clarify the meaning of prediction

resistance.

In Section 9, a prediction_resistance_request parameter has been added to the
Get_entropy_input call, along with a description of its purpose to the text underneath
the call.

10.

In Section 9, a footnote was inserted to explain why a prediction_resistance_request
parameter may be useful in the Get_entropy_input call.

11.

In Section 9.1, the following changes were made:
...
In Section 9.2, the following changes have been made:
...
In Section 9.3.1, the following changes were made:
...
In Section 9.3.2, step e, a phrase addressing the presence of the

prediction_resistance_request indicator was inserted.

In Sections 10.1 and 10.3.1, the new hash functions approved in FIPS 180-4 have been
added.

In Sections 10.1.2 (HMAC_DRBG) and 10.2.1 (CTR_DRBG), the update functions
have been renamed to reflect the DRBG with which they are associated (i.e., renamed
to HMAC_DRBG_Update and CTR_DRBG_Update).

In Section 10.1.2.1, the last paragraph has been revised to indicate that only the Key is
considered to be a critical value.

In Sections 10.1.2.3, 10.2.1.3.1, 10.2.1.3.2 and 10.3.1.2, the description of the
...
In Section 10.2.1.5, the following statement has been added to the first paragraph:
...
In Section 10.3.1.2, the specification was changed to select an elliptic curve and return
the parameters of that curve to the Instantiate_function that called the routine.

In the first paragraph of Appendix A.1, a statement has been added that if alternative
...
In Appendix C.2 (originally Appendix E.2), a paragraph has been inserted after the
...
In Appendix D.3 (originally Appendix F.3), the first paragraph, which  discusses the
